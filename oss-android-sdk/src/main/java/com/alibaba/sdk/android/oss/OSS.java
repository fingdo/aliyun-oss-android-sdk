...
public interface OSS {
     ...
     *
     * @param request           A {@link GetBucketInfoRequest} instance which specifies the bucket
     *                          name.
     * @param completedCallback A {@link OSSCompletedCallback<GetBucketInfoRequest, GetBucketInfoResult>} instance that specifies callback functions
     * @return
     */
     ...
     * @throws ServiceException OSS Server side exception.
     */
     ...
     *
     * @param request A {@link PutSymlinkRequest} instance that specifies the
     ...
     * @param request           A {@link PutSymlinkRequest} instance that specifies the
     *                          bucket name, symlink name.
     * @param completedCallback A {@link OSSCompletedCallback<PutSymlinkRequest, PutSymlinkResult>} instance that specifies callback functions
     ...
     *
     * @param request A {@link GetSymlinkRequest} instance which specifies the bucket
     ...
     * @param request           A {@link GetSymlinkRequest} instance which specifies the bucket
     *                          name and symlink name.
     * @param completedCallback A {@link OSSCompletedCallback<GetSymlinkRequest, GetSymlinkResult>} instance that specifies callback functions
     ...
     *
     * @param request A {@link RestoreObjectRequest} instance that specifies the bucket
     *                name and object key.
     ...
     * @param request           A {@link RestoreObjectRequest} instance that specifies the bucket
     *                          name and object key.
     * @param completedCallback A {@link OSSCompletedCallback<RestoreObjectRequest, RestoreObjectResult>} instance that specifies callback functions
